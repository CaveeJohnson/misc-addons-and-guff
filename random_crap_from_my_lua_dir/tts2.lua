...
tts.focus   = CreateClientConVar("tts_require_focus", "1", true, true, "Should TTS require the game to be focused?")

hook.Add("OnPlayerChat", "tts", function(ply, text)
	if (system.HasFocus() == false and tts.focus:GetBool()) or not tts.enabled:GetBool() then return end
